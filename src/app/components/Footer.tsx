...
const Footer = () => {
  return (
    <footer className="w-full pt-12 pb-6 text-center text-sm text-gray-500">
      <p className="font-medium">
        Todos los derechos reservados &copy; {new Date().getFullYear()}{" "}
        <a 
          href="https://patriciadiaz.dev" 
          target="_blank" 
      ...
      <div className="mt-4 flex flex-col items-center gap-3">
        <motion.a
          ...
          className="flex items-center gap-2 text-[#E1306C] transition-all duration-300"
